...
nodes:
	...
	multipass launch --cpus 2 --mem 2G --disk 8G --name=master-01
	multipass launch --cpus 2 --mem 2G --disk 8G --name=worker-01
	multipass launch --cpus 2 --mem 2G --disk 8G --name=worker-02
cluster:
